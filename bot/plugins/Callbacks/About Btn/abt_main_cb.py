...
async def cb_about(bot, update: CallbackQuery):
    ...
    text+=f"""\n<b><i>Bot Support:</i></b> <a href="https://t.me/vlIeYa9keYUxZDY1">@vlIeYa9keYUxZDY1</a>\n"""
    text+="""\n<b><i>Source Code:</i></b> <a href="https://github.com/Alanstalinvellimon/Test">Source</a>"""

    buttons = [
        [
            InlineKeyboardButton
                (
                    "My Dev ⚡", url="https://t.me/MOVIES_SQUAD_ADMIN"
                ),
